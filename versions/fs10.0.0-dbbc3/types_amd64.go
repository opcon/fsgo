...
// cgo -godefs fs10.0.0-dbbc3/types.go
...
type (
	...
	__locale_struct struct {
		XLocales      [13]*__locale_data `json:"__locales"`
		XCtypeB       *uint16            `json:"__ctype_b"`
		XCtypeTolower *int32             `json:"__ctype_tolower"`
		XCtypeToupper *int32             `json:"__ctype_toupper"`
		XNames        [13]*byte          `json:"__names"`
	}
	Bank_set_mon struct {
		ActiveBank struct {
	...
	Dbbab struct {
		Host      [129]byte `json:"host"`
		padCgo0   [3]byte
		Port      int32     `json:"port"`
		TimeOut   int32     `json:"time_out"`
		McastAddr [129]byte `json:"mcast_addr"`
		padCgo1   [3]byte
		McastPort int32    `json:"mcast_port"`
		McastIf   [16]byte `json:"mcast_if"`
	}
	...
	Dbbc3_core3h_modex_mon struct {
		Clockrate struct {
			Clockrate int32   `json:"clockrate"`
			State     M5state `json:"state"`
		} `json:"clockrate"`
		Splitmode struct {
			Splitmode int32   `json:"splitmode"`
			State     M5state `json:"state"`
		} `json:"splitmode"`
		VsiInput struct {
			VsiInput int32   `json:"vsi_input"`
			State    M5state `json:"state"`
		} `json:"vsi_input"`
		Mask4 struct {
			Mask4 uint32  `json:"mask4"`
			State M5state `json:"state"`
		} `json:"mask4"`
		Mask3 struct {
			Mask3 uint32  `json:"mask3"`
			State M5state `json:"state"`
		} `json:"mask3"`
	}
	...
	Dbbc3_tsys_bbc struct {
		TsysLsb float32 `json:"tsys_lsb"`
		TsysUsb float32 `json:"tsys_usb"`
		Freq    uint32  `json:"freq"`
	}
	Dbbc3_tsys_cycle struct {
		Last     int64    `json:"last"`
		Centisec [6]int32 `json:"centisec"`
		Hsecs    int32    `json:"hsecs"`
		padCgo0  [4]byte
		Ifc      [8]Dbbc3_tsys_ifc   `json:"ifc"`
		Bbc      [128]Dbbc3_tsys_bbc `json:"bbc"`
	}
	Dbbc3_tsys_data struct {
		Iping   int32 `json:"iping"`
		padCgo0 [4]byte
		Data    [2]Dbbc3_tsys_cycle `json:"data"`
	}
	Dbbc3_tsys_ifc struct {
		Lo        float64 `json:"lo"`
		Sideband  int32   `json:"sideband"`
		Delay     uint32  `json:"delay"`
		Time      int64   `json:"time"`
		TimeError int32   `json:"time_error"`
		VdifEpoch int32   `json:"vdif_epoch"`
		Tsys      float32 `json:"tsys"`
		padCgo0   [4]byte
	}
	...
	Dbtcn struct {
		Control [2]Dbtcn_control `json:"control"`
		Iping   int32            `json:"iping"`
	}
	Dbtcn_control struct {
		Continuous  int32          `json:"continuous"`
		Cycle       int32          `json:"cycle"`
		StopRequest int32          `json:"stop_request"`
		ToErrorOff  int32          `json:"to_error_off"`
	...
	Fscom struct {
		...
		Dbbc3DdcuV        int32                `json:"dbbc3_ddcu_v"`
		Dbbc3DdcuVs       [16]byte             `json:"dbbc3_ddcu_vs"`
		Dbbc3DdcuVc       int32                `json:"dbbc3_ddcu_vc"`
		...
		Fortran           [33]byte             `json:"fortran"`
		padCgo14          [2]byte
		RxgainFiles       [20]Rxgain_files_ds       `json:"rxgain_files"`
		Dbbad             Dbbab                     `json:"dbbad"`
		Dbtcn             Dbtcn                     `json:"dbtcn"`
		Dbbc3DdcvV        int32                     `json:"dbbc3_ddcv_v"`
		Dbbc3DdcvVs       [16]byte                  `json:"dbbc3_ddcv_vs"`
		Dbbc3DdcvVc       int32                     `json:"dbbc3_ddcv_vc"`
		Dbbc3Mcdelay      int32                     `json:"dbbc3_mcdelay"`
		Dbbc3Iscboard     int32                     `json:"dbbc3_iscboard"`
		Dbbc3Core3hModex  [8]Dbbc3_core3h_modex_cmd `json:"dbbc3_core3h_modex"`
		Dbbc3TsysData     Dbbc3_tsys_data           `json:"dbbc3_tsys_data"`
	}
	Fserr_cls struct {
	...
	Itimerspec struct {
		Interval Timespec `json:"it_interval"`
		Value    Timespec `json:"it_value"`
	}
	K3fm_cmd struct {
		Mode     int32    `json:"mode"`
		Rate     int32    `json:"rate"`
	...
	Rxgain_files_ds struct {
		File    [129]byte `json:"file"`
		padCgo0 [3]byte
		Logged  int32 `json:"logged"`
	}
	S2_out struct {
	...
	Timespec struct {
		Sec  int64 `json:"tv_sec"`
		Nsec int64 `json:"tv_nsec"`
	}
	Tle_cmd struct {
		Tle0    [25]byte `json:"tle0"`
		Tle1    [70]byte `json:"tle1"`
	...
	Tm struct {
		Sec     int32 `json:"tm_sec"`
		Min     int32 `json:"tm_min"`
		Hour    int32 `json:"tm_hour"`
		Mday    int32 `json:"tm_mday"`
		Mon     int32 `json:"tm_mon"`
		Year    int32 `json:"tm_year"`
		Wday    int32 `json:"tm_wday"`
		Yday    int32 `json:"tm_yday"`
		Isdst   int32 `json:"tm_isdst"`
		padCgo0 [4]byte
		Gmtoff  int64 `json:"tm_gmtoff"`
		Zone    *byte `json:"tm_zone"`
	}
	Tpicd_cmd struct {
		Continuous  int32        `json:"continuous"`
		Cycle       int32        `json:"cycle"`
