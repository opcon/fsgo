...
type (
	...
	Fscom struct {
		...
		Tpi     [36]int32   `json:"tpi"`
		Tpical  [36]int32   `json:"tpical"`
		Tpizero [36]int32   `json:"tpizero"`
		Equip   struct {
		...
		Tpidiff               [36]int32       `json:"tpidiff"`
		Tpidiffgain           [36]int32       `json:"tpidiffgain"`
