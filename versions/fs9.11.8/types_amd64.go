...
type (
	...
	Fscom struct {
		...
		Tpi     [36]int64   `json:"tpi"`
		Tpical  [36]int64   `json:"tpical"`
		Tpizero [36]int64   `json:"tpizero"`
		Equip   struct {
		...
		padCgo9               [4]byte
		Tpidiff               [36]int64   `json:"tpidiff"`
		Tpidiffgain           [36]int64   `json:"tpidiffgain"`
		Caltemps              [36]float32 `json:"caltemps"`
	...
	Onoff_cmd struct {
		...
		Proc        [33]byte `json:"proc"`
		padCgo0     [7]byte
		Devices     [42]Onoff_devices `json:"devices"`
		Itpis       [42]int32         `json:"itpis"`
	...
	Tpicd_cmd struct {
		...
		StopRequest int32       `json:"stop_request"`
		Itpis       [36]int32   `json:"itpis"`
		Ifc         [36]int32   `json:"ifc"`
		Lwhat       [36][2]byte `json:"lwhat"`
