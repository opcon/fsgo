...
type (
	...
	Onoff_cmd struct {
		...
		Proc        [33]byte `json:"proc"`
		padCgo0     [7]byte
		Devices     [134]Onoff_devices `json:"devices"`
		Itpis       [134]int32         `json:"itpis"`
	...
	Rdbe_tsys_cycle struct {
		...
		PcalAmp   [1024]float32  `json:"pcal_amp"`
		PcalPhase [1024]float32  `json:"pcal_phase"`
