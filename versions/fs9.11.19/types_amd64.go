...
type (
	...
	Dqa_chan struct {
		...
		CrccA   uint64  `json:"crcc_a"`
		CrccB   uint64  `json:"crcc_b"`
		Resync  uint64  `json:"resync"`
		Nosync  uint64  `json:"nosync"`
	...
	Fscom struct {
		Iclbox      int64     `json:"iclbox"`
		Iclopr      int64     `json:"iclopr"`
		...
		Check   struct {
			...
			BbcTime   [16]int64 `json:"bbc_time"`
			Dist      [2]int32  `json:"dist"`
			Vform     int32     `json:"vform"`
			padCgo0   [4]byte
			FmCnTm    int64       `json:"fm_cn_tm"`
		...
		Tpi     [68]int64   `json:"tpi"`
		Tpical  [68]int64   `json:"tpical"`
		Tpizero [68]int64   `json:"tpizero"`
		Equip   struct {
		...
		Time       struct {
			...
			Epoch     [2]int64   `json:"epoch"`
			Span      [2]int64   `json:"span"`
			SecsOff   int64      `json:"secs_off"`
			Index     int32      `json:"index"`
			Icomputer [2]int32   `json:"icomputer"`
			Model     byte       `json:"model"`
			padCgo0   [3]byte
			TicksOff  uint64 `json:"ticks_off"`
			UsecsOff  int64  `json:"usecs_off"`
		...
		BbcTpi                [16][2]uint64   `json:"bbc_tpi"`
		VifdTpi               [4]uint64       `json:"vifd_tpi"`
		MifdTpi               [3]uint64       `json:"mifd_tpi"`
		...
		Flux                  [50]Flux_ds     `json:"flux"`
		padCgo9               [4]byte
		Tpidiff               [68]int64   `json:"tpidiff"`
		Tpidiffgain           [68]int64   `json:"tpidiffgain"`
		Caltemps              [68]float32 `json:"caltemps"`
		...
		padCgo11              [4]byte
		Das                   [2]Das    `json:"das"`
		IfpTpi                [4]uint64 `json:"ifp_tpi"`
		MDas                  byte      `json:"m_das"`
		Mk5vsn                [33]byte  `json:"mk5vsn"`
		padCgo12              [6]byte
		Mk5vsnLogchg          int64           `json:"mk5vsn_logchg"`
		Logchg                int64           `json:"logchg"`
	...
	Ft struct {
		...
		padCgo0         [4]byte
		NcoCentreValue  uint64 `json:"nco_centre_value"`
		NcoOffsetValue  uint64 `json:"nco_offset_value"`
		NcoPhaseValue   uint64 `json:"nco_phase_value"`
		NcoTimerValue   uint64 `json:"nco_timer_value"`
	...
	Lo_cmd struct {
		Lo       [4]float64 `json:"lo"`
		Sideband [4]int32   `json:"sideband"`
		Pol      [4]int32   `json:"pol"`
		Spacing  [4]float64 `json:"spacing"`
		Offset   [4]float64 `json:"offset"`
		Pcal     [4]int32   `json:"pcal"`
	}
	M5state struct {
	...
	Mk5b_mode_mon struct {
		...
		Tbitrate struct {
			Tbitrate float32 `json:"tbitrate"`
			State    M5state `json:"state"`
		} `json:"tbitrate"`
		Framesize struct {
	...
	Onoff_cmd struct {
		...
		Proc        [33]byte `json:"proc"`
		padCgo0     [7]byte
		Devices     [74]Onoff_devices `json:"devices"`
		Itpis       [74]int32         `json:"itpis"`
	...
	Tle_cmd struct {
		...
		Tle2    [70]byte `json:"tle2"`
		padCgo0 [3]byte
		Catnum  [3]int64 `json:"catnum"`
	}
	Tpicd_cmd struct {
		Continuous  int32       `json:"continuous"`
		Cycle       int32       `json:"cycle"`
		StopRequest int32       `json:"stop_request"`
		Itpis       [68]int32   `json:"itpis"`
		Ifc         [68]int32   `json:"ifc"`
		Lwhat       [68][4]byte `json:"lwhat"`
