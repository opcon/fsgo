...
type (
	...
	Fscom struct {
		...
		Tpi     [68]int32   `json:"tpi"`
		Tpical  [68]int32   `json:"tpical"`
		Tpizero [68]int32   `json:"tpizero"`
		Equip   struct {
		...
		Tpidiff               [68]int32       `json:"tpidiff"`
		Tpidiffgain           [68]int32       `json:"tpidiffgain"`
