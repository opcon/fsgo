...
type (
	...
	Fscom struct {
		...
		Tpi     [264]int64  `json:"tpi"`
		Tpical  [264]int64  `json:"tpical"`
		Tpizero [264]int64  `json:"tpizero"`
		Equip   struct {
		...
		Tpigain               [264]int64      `json:"tpigain"`
		...
		padCgo9               [4]byte
		Tpidiff               [264]int64   `json:"tpidiff"`
		Tpidiffgain           [264]int64   `json:"tpidiffgain"`
